...
export default function PolicyCard({ title }) {
  const policies = [
    { resource: "database-prod", access: "GRANTED", desc: "Production DB access" },
    { resource: "admin-panel", access: "DENIED", desc: "Restricted admin controls" },
    { resource: "file-server", access: "GRANTED", desc: "Internal document server" },
    { resource: "vpn-gateway", access: "GRANTED", desc: "Corporate VPN gateway" },
  ];
